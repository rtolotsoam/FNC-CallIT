...
{
    $matricule_tlc = (int) $matricule_tlc;
...
{
    $matricule_acc = (int) $matricule_acc;
    global $conn;
...
<p><b>Une fois le d&eacute;brief du conseiller effectu&eacute;, veuillez consulter la r&eacute;f&eacute;rence <span class='link'>" . $ref_nc . "</span> pour l'enregistrement des &eacute;l&eacute;ments <b></p>
...
// $mail->AddAddress('si@vivetic.mg', 'XX');     // adresse du destinataire
//
...
$liste_sortant = array('mickaelle_cc@vivetic.mg||Mickaelle');
