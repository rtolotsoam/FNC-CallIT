...
(function($){
    $.fn.smartWizard = function(action) {
        ...
        return this.each(function(){
                ...
                function init(){
                  ...
                  btNext = $('<a onclick="getValeur();">'+options.labelNext+'</a>').attr("href","#").addClass("buttonNext");
                  btPrevious = $('<a>'+options.labelPrevious+'</a>').attr("href","#").addClass("buttonPrevious");
                  btFinish = $('<a onclick="setValeur();">'+options.labelFinish+'</a>').attr("href","#").addClass("buttonFinish");
    ...
    $.fn.smartWizard.defaults = {
          ...
          labelNext:'Suivant',
          labelPrevious:'Pr&eacute;c&eacute;dent',
